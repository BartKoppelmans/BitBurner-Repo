declare module 'Bitburner' {
	...
	export interface TIX {
		 ...
		 * @ramCost 2 GB
		 * @param {string} sym Stock symbol.
		 * @returns {[number,number,number,number]} Array of four elements that represents the player’s position in a
		 *     stock.
		 */
		 ...
		 * @returns {number} The stock price at which each share was purchased, otherwise 0 if the shares weren't
		 *     purchased.
		 */
		 ...
		 * @example
		 * ```js
		 * "If you do not have orders in Nova Medical (NVMD), then the returned object will not have a “NVMD”
		 *     property."
		 * {
		 *  ECP: [
		 *      {
		 ...
		 * ```
		 * @ramCost 2.5 GB
		 * @returns {object} Object containing information for all the Limit and Stop Orders you have in the stock
		 *     market.
		 */
		 ...
		 * @ramCost 2.5 GB
		 * @param {string} sym Stock symbol.
		 * @returns {number} Probability that the specified stock’s price will increase (as opposed to decrease) during
		 *     the next tick.
		 */
	...
	export interface Singularity {
		 ...
		 * @ramCost 2 GB
		 * @singularity Level 1
		 * @param {string} universityName Name of university. You must be in the correct city for whatever university
		 *     you specify.
		 ...
		 * @ramCost 3 GB
		 * @singularity Level 2
		 * @param {string} [companyName] Name of company to work for. Must be an exact match. Optional. If not
		 *     specified, this argument defaults to the last job that you worked
		 ...
		 * @singularity Level 2
		 * @param {string} companyName Name of the company.
		 * @returns {number} Amount of favor you gain at the specified company when you reset by installing
		 *     Augmentations.
		 */
		 ...
		 * @singularity Level 2
		 * @param {string} faction Name of faction.
		 * @returns {number} Amount of favor you will gain for the specified faction when you reset by installing
		 *     Augmentations.
		 */
		 ...
		 * @ramCost 5 GB
		 * @singularity Level 3
		 * @param {boolean} [purchased] Specifies whether the returned array should include Augmentations you have
		 *     purchased but not yet installed. By default, this argument is false which means that the return value
		 *     will NOT have the purchased Augmentations.
		 ...
		 * @singularity Level 3
		 * @param {string} augName Name of Augmentation.
		 * @returns {[number, number]} Array with first element as a reputation requirement and second element as the
		 *     money cost.
		 */
		 ...
		 * @ramCost 5 GB
		 * @singularity Level 3
		 * @param {string} cbScript Optional callback script. This is a script that will automatically be run after
	...
	export interface HackNet {
		 ...
		 *
		 * @ramCost 0 GB
		 * @returns {number} The index of the Hacknet Node or if the player cannot afford to purchase a new Hacknet
		 *     Node the function will return -1.
		 */
		purchaseNode(): number;
	...
	export interface BladeBurner {
		 ...
		 *
		 * @ramCost 4 GB
		 * @returns {boolean} True if you successfully join the Bladeburner faction, or if you are already a member,
		 *     false otherwise.
		 */
		 ...
		 *
		 * @ramCost 4 GB
		 * @returns {boolean} True if you successfully join the Bladeburner division, or if you are already a member,
		 *     false otherwise.
		 */
	...
	export interface CodingContract {
		 ...
		 * @param {string} [host] Host or IP of the server containing the contract. Optional. Defaults to current
		 ...
		 * @returns {boolean} True if the solution was correct, false otherwise. If the returnReward option is
		 *     configured, then the function will instead return a string. If the contract is successfully solved, the
		 *     string will contain a description of the contract’s reward. Otherwise, it will be an empty string.
		 */
		attempt(
			answer: string | string[] | number,
			fn: string,
	...
	export interface Gang {
		 ...
		 * @returns {number} Cost to purchase the specified Equipment/Augmentation (number). Infinity for invalid
		 *     arguments
		 */
	...
	export interface BitBurner extends TIX, Singularity {
		 ...
		 * @param {object} [opts] Optional parameters for configuring function behavior.
		 * @returns {Promise<number>} The amount by which the target server’s security level was decreased. This is
		 *     equivalent to 0.05 multiplied by the number of script threads.
		 */
		 ...
		 * @returns {number} The amount of {@link grow} calls needed to grow the specified server by the specified
		 *     amount
		 */
		 ...
		 * @returns {boolean} Returns a boolean indicating whether or not logging is enabled for that function (or
		 *     `ALL`)
		 */
		 ...
		 * @returns {string[]} Returns an string array, where each line is an element in the array. The most recently
		 *     logged line is at the end of the array.
		 */
		 ...
		 * @param {boolean} hostnames Optional boolean specifying whether the function should output hostnames (if
		 *     true) or IP addresses (if false).
		 */
		 ...
		 * @param {number} [numThreads] Optional thread count for new script. Set to 1 by default. Will be rounded to
		 *     nearest integer.
		 * @param {...string} [args] Additional arguments to pass into the new script that is being run. Note that if
		 *     any arguments are being passed into the new script, then the second argument numThreads must be filled
		 *     in with a value.
		 ...
		 *     nearest integer.
		 * @param {...string} [args] Additional arguments to pass into the new script that is being run. Note that if
		 *     any arguments are being passed into the new script, then the third argument numThreads must be filled in
		 *     with a value.
		 * @returns {number} Returns the PID of a successfully started script, and 0 otherwise.
		 */
		exec(
		 ...
		 * @param {(string|number)} destination Host or IP of the destination server, which is the server to which the
		 *     file will be copied.
		 * @returns {boolean} True if the script/literature file is successfully copied over and false otherwise. If
		 *     the files argument is an array then this function will return true if at least one of the files in the
		 *     array is successfully copied.
		 */
		 ...
		 * @ramCost 0.6 GB
		 * @param {(string|string[])} files Filename or an array of filenames of script/literature files to copy.
		 * @param {(string|number)} source Host or IP of the source server, which is the server from which the file
		 *     will be copied. This argument is optional and if it’s omitted the source will be the current server.
		 * @param {(string|number)} destination Host or IP of the destination server, which is the server to which the
		 *     file will be copied.
		 * @returns {boolean} True if the script/literature file is successfully copied over and false otherwise. If
		 *     the files argument is an array then this function will return true if at least one of the files in the
		 ...
		 * ```
		 * @ramCost 0.2 GB
		 * @param {string} host Host or IP address of the target server. If not specified, it will be the current
		 *     server’s IP by default.
		 ...
		 * @ramCost 0.1 GB
		 * @param {string} host Host or IP of target server.
		 * @returns {number} Parameter that affects the percentage by which the server’s money is increased when using
		 *     the {@link grow} function.
		 */
		 ...
		 * @param {(string|number)} [host] Host or IP of target server. This is optional. If it is not specified then
		 ...
		 * ```
		 * @ramCost 0.25 GB
		 * @param {number} ram Amount of RAM of a potential purchased server. Must be a power of 2 (2, 4, 8, 16, etc.).
		 *     Maximum value of 1048576 (2^20).
		 ...
		 * @param {number} ram Amount of RAM of the purchased server. Must be a power of 2 (2, 4, 8, 16, etc.). Maximum
		 ...
		 *
		 * @ramCost 2.25 GB
		 * @param {boolean} hostname Specifies whether hostnames or IP addresses should be returned. If it’s true then
		 *     hostnames will be returned, and if false then IPs will be returned. If this argument is omitted then it
		 *     is true by default.
		 * @returns {string[]} Returns an array with either the hostnames or IPs of all of the servers you have
		 *     purchased.
		 */
		 ...
		 * @param {string} [host] Host or IP Address of the server on which to delete the file. Optional. Defaults to
		 *     current server.
		 ...
		 * @param {string} [host] Host or IP of target server the script is located on. This is optional, If it is not
		 *     specified then the function will se the current server as the target server.
		 * @returns {string} Amount of RAM required to run the specified script on the target server, and 0 if the
		 ...
		 * @ramCost 0.05 GB
		 * @param {string} host Host or IP of target server.
		 * @param {number} [hackLvl] Optional hacking level for the calculation. Defaults to player’s current hacking
		 *     level.
		 * @param {number} [intLvl] Optional intelligence level for the calculation. Defaults to player’s current
		 *     intelligence level. (Intelligence is unlocked after obtaining Source-File 5).
		 * @returns {number} Returns the amount of time in seconds it takes to execute the {@link hack} Netscript
		 *     function. Returns Infinity if called on a Hacknet Server.
		 */
		 ...
		 * @param {number} [intLvl] Optional intelligence level for the calculation. Defaults to player’s current
		 *     intelligence level. (Intelligence is unlocked after obtaining Source-File 5).
		 * @returns {number} Returns the amount of time in seconds it takes to execute the {@link grow} Netscript
		 *     function. Returns Infinity if called on a Hacknet Server.
		 */
