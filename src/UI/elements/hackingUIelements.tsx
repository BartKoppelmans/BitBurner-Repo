...
export const ServerEntry = (ns: NS, server: HackableServer): JSX.Element => {
	return (<tbody className='serverEntry'>
		<tr className={`serverEntryOverview ${getServerStatusClass(server.status)} server-${server.characteristics.id}`} onClick={(e: MouseEvent) => toggleServerEntryDetails(e, server)}>
