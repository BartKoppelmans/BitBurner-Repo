...
export interface Bladeburner {
	 ...
	 */
	getSkillUpgradeCost(skillName: string): number;
	 ...
	 * @returns true if the skill is successfully upgraded, and false otherwise.
	 */
	upgradeSkill(skillName: string): boolean;
...
export interface NS extends Singularity {
	 ...
	 * @param intLvl - Optional intelligence level for the calculation. Defaults to player’s current intelligence
	 *     level. (Intelligence is unlocked after obtaining Source-File 5).
	 * @returns Returns the amount of time in seconds it takes to execute the grow Netscript function. Returns Infinity
	 *     if called on a Hacknet Server.
	 */
	 ...
	 * The function takes in an optional hackLvl parameter that can be specified to see what the weaken time would be
	 *     at different hacking levels.
	 *
	 * @param host - Host of target server.
	 * @param hackLvl - Optional hacking level for the calculation. Defaults to player’s current hacking level.
	 * @param intLvl - Optional intelligence level for the calculation. Defaults to player’s current intelligence
